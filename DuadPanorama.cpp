...
#define Size_ARGB_F 960*400*4
#define Size_ARGB_R 768*300*4

#define Size_Out_AGRB 640*320*4

#define av_inSize_F Size(960, 400)
#define av_inSize_R Size(768, 300)
...
void get_Univariate_matrix(void)
{
		...
		findChessboardCorners(img, Size(18,9), corners, cv::CALIB_CB_ADAPTIVE_THRESH | cv::CALIB_CB_NORMALIZE_IMAGE);
		
		findChessboardCorners(img_r, Size(18,9), corners_r, cv::CALIB_CB_ADAPTIVE_THRESH | cv::CALIB_CB_NORMALIZE_IMAGE);
