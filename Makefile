...
LIBS = -L$(DEP_LIB_DIR) -L/opt/sgks/arm-linux/arm-buildroot-linux-gnueabi/sysroot/usr/lib  -lpthread -lstdc++ -mcpu=cortex-a7 -lOpenCL -mtune=cortex-a7 -mfpu=vfpv4-d16 -mfloat-abi=softfp -lz -lrt -lm -ldl -lCLC -lLLVM_viv -lVSC -lGAL -fopenmp
...
OPT = -O3
objects = DuadPanorama.o panorama.o fftm.o cl_api.o
out_obj = DuadPanorama.o panorama.o fftm.o cl_api.o demo.o
edit:$(out_obj)
